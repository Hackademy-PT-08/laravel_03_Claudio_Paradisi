            ...
            <div class="row">
                ...
                <div id="card" class="col-12 col-md-4">
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{$region['type']}}</h5>
                            <h6 class="card-subtitle text-muted">{{$region['region']}}</h6>
                        </div>
                        <div xmlns="http://www.w3.org/2000/svg" class="d-block user-select-none" width="100%" height="200" aria-label="Placeholder: Image cap" focusable="false" role="img" preserveAspectRatio="xMidYMid slice" viewBox="0 0 318 180" style="font-size:1.125rem;text-anchor:middle">
                            ...
                            <img class="img-fluid" src="{{$region['img']}}" alt="" style="height: 300px; width:100%"/>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                        <a class="btn btn-success text-white" href="{{route('ricette', [$region['id']])}}" role="button">La ricetta</a>
